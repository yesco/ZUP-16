...
module dropbit #(
    ...
    always @(*) begin
        ...
        case (opcode)
            ...
            3'b010: begin
                if (drop_bit) begin
                    // OVER: The global defaults already handle next_tos=nos and next_nos=n2!
                    // We don't need any overrides here; it naturally matches DROP.
                end else begin
                    // TUCK: NOS gets TOS, N2 gets old NOS
                    next_nos = tos;
                    next_n2  = nos;
                    sd       = SIGNED_PUSH;
                end
